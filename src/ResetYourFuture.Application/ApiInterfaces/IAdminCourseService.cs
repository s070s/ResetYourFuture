...
public interface IAdminCourseService
{
    ...
    Task<PagedResult<AdminCourseDto>> GetCoursesAsync(int page, int pageSize, string sortBy, string sortDir, string? search = null, CancellationToken cancellationToken = default);
