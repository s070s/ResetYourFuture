...
{
    /// <inheritdoc />
    public partial class AddAuditableEntityCreatedByUserId : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SummaryEl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    ContentEn = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ContentEl = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogArticles_Published_PublishedAt",
                table: "BlogArticles",
